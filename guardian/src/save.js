...
export function defaultState() {
  return { player: { ...spawnPoint(), hp: PLAYER_MAX_HP }, inventory: [] }
}
...
// Returns null on corrupt JSON, missing player/inventory fields, or a schema version
// mismatch — the caller falls back to defaultState() in every case.
export function deserialize(raw) {
  ...
  return { player: parsed.player, inventory: parsed.inventory }
}
